...
const rentalPage = () => {
    return (
        ...
        <div className="container items-center justify-center text-center mt-[100px] py-[48px] mb-[76px]">
            <h2 className="text-[48px] font-bold mb-2 text-[#212529]">Cari Kendaraan Untuk Anda</h2>
            <p className = "text-[16px] text-[#495057]">Temukan kendaraan yang sesuai dengan kebutuhan perjalanan Anda.</p>
        </div>
        <SearchbBar />
