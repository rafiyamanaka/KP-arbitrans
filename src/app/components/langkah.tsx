...
export default function LangkahRental() {
    const steps = [
        { title: "Pilih Jenis Kendaraan", desc: "Pilih antara mobil atau motor sesuai kebutuhanmu." },
        { title: "Pilih Tanggal Sewa", desc: "Gunakan kalender untuk memilih tanggal mulai dan kembali." },
        { title: "Pilih dan Lihat Detail Kendaraan", desc: "Jelajahi daftar kendaraan yang tersedia." },
        { title: "Pilih Paket Rental dan Pesan via WhatsApp", desc: "Otomatis diarahkan ke WhatsApp dengan template pesan siap kirim." },
        { title: "Konfirmasi Pemesanan dengan Pihak Rental", desc: "Pemilik akan menjawab dan memproses sewa kamu secara langsung." },
    ];
